...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  // THEME
  static const bg = Color(0xFFFAF6ED);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white,
          border: Border.all(color: _AdminDashboardPageState.border),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  title,
                  style: const TextStyle(color: _AdminDashboardPageState.sub),
                ),
                const SizedBox(height: 4),
                Text(
                  value,
                  style: const TextStyle(
                    color: _AdminDashboardPageState.ink,
